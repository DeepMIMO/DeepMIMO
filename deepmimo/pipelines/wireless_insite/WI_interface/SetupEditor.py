...
class SetupEditor:
    ...
    def __init__(self, scenario_path: str) -> None:
        ...
        with open(os.path.join(setup_template_folder, "template.setup")) as f:
