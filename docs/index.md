...
<div class="hero">
	...
	<div class="hero-actions">
		<a class="md-button md-button--primary" href="quickstart.html">Launch the quickstart</a>
		<a class="md-button md-button--secondary" href="installation.html">Install DeepMIMO</a>
		<a class="md-button" href="tutorials/manual.html">Open the notebook manual</a>
	</div>
</div>
